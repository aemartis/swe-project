...
public class clean{
        ...
        public static void main(String[] args){
            ...
            filter();
            System.out.println("Fixing attributes...");
            attributeFixerV2();
        }
    ...
    public static void attributeFixerV2() {
        try {
    ...
    public static void collectAttributes(){
        try{
            FileWriter writer = new FileWriter("collectedAttributes.csv");
            BufferedReader br = new BufferedReader(new FileReader(new File("attributes.json")));
            String line;
